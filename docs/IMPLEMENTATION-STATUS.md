...
- Manny approved the definitive portrait, separately composed front driver frame, and neutral rear chase-camera frame.
- Runtime derivatives are stored at `public/assets/characters/aa-10/`. The portrait is 256 x 256; the front and rear frames are 512 x 512. All are sRGB RGBA PNGs with genuine transparency and transparent corner pixels.
- The front frame contains no kart or steering-wheel geometry and preserves a seated, two-handed neutral driving pose.
- Steer-left, steer-right, hit, victory, kart GLBs, manifest activation, CI, deployment, and live verification remain pending.
- Status: **IN PROGRESS — PORTRAIT, FRONT, AND REAR FRAMES APPROVED.**
