...
- **Placement correction:** Manny's 2026-09-02 live review found `[0, 0.45, -0.12]` too low behind Potato. The local correction uses `[0, 0.9, -0.12]` for all five camera-facing states. No asset bytes, kart geometry, chase placement, or steering-control ownership change.
